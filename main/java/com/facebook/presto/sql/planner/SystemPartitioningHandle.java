        ...
        implements ConnectorPartitioningHandle
{
    ...
    private static final Logger LOG = Logger.get(SystemPartitioningHandle.class);
    ...
    public NodePartitionMap getNodePartitionMap(Session session, NodeScheduler nodeScheduler, Optional<Predicate<Node>> nodePredicate, Optional<StageId> stageID)
    {
        NodeSelector nodeSelector = nodeScheduler.createNodeSelector(session, null, nodePredicate, stageID);
        List<InternalNode> nodes;
        LOG.debug("SelectNodes %d", stageID.get().getId());
