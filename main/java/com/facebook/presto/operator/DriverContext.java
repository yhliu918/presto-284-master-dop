...
public class DriverContext
{
    ...
    private final AtomicReference<DateTime> outputTime = new AtomicReference<>();
    ...
    public void startOutputTimer()
    {
        if (outputTime.get() == null) {
            outputTime.set(DateTime.now());
            pipelineContext.startOutputTimer();
        }
    }
