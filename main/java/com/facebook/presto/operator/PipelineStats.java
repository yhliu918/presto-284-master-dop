...
public class PipelineStats
{
    ...
    private final DateTime firstOutputTime;
    ...
    public PipelineStats(
            ...
            @JsonProperty("firstOutputTime") DateTime firstOutputTime,
            ...
            @JsonProperty("drivers") List<DriverStats> drivers)
    {
        ...
        this.firstOutputTime = firstOutputTime;
    ...
    @JsonProperty
    @ThriftField(5)
    public DateTime getFirstOutputTime()
    {
